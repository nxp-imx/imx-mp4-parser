...
*/
/*
    $Id: MP4InitialObjectDescriptor.c,v 1.2 2000/05/17 08:01:29 francesc Exp $
*/
#include <stdlib.h>
#include <string.h>
...
static MP4Err createFromInputStream(struct MP4DescriptorRecord* s, MP4InputStreamPtr inputStream) {
    ...
    DEBUG_SPRINTF("objectDescriptorID = %d", (int)self->objectDescriptorID);
    DEBUG_SPRINTF("urlflag = %d", (int)urlflag);
    DEBUG_SPRINTF("inlineProfileFlag = %d", (int)self->inlineProfileFlag);
