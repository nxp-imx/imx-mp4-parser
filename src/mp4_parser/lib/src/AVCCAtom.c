...
static MP4Err createFromInputStream(MP4AtomPtr s, MP4AtomPtr proto, MP4InputStreamPtr inputStream) {
    MP4Err err;
    u32 bytesToRead;
    MP4AVCCAtomPtr self = (MP4AVCCAtomPtr)s;
    ...
    if (bytesToRead > 0) {
        ...
        GETBYTES_MSG(bytesToRead, data, "AVC");
...
MP4Err MP4CreateAvccAtom(MP4AVCCAtomPtr* outAtom) {
    MP4Err err;
    MP4AVCCAtomPtr self;

    self = (MP4AVCCAtomPtr)MP4LocalCalloc(1, sizeof(MP4AVCCAtom));
    TESTMALLOC(self)
