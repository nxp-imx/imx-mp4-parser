...
*/
/*
    $Id: SLConfigDescriptor.c,v 1.15 2000/06/11 07:38:50 mc Exp $
*/
#include <stdlib.h>
...
static MP4Err createFromInputStream(struct MP4DescriptorRecord* s, MP4InputStreamPtr inputStream) {
    ...
    if (self->predefined) {
        ...
        DEBUG_SPRINTF("useAccessUnitStartFlag = %d", (int)self->useAccessUnitStartFlag);
        DEBUG_SPRINTF("useAccessUnitEndFlag = %d", (int)self->useAccessUnitEndFlag);
        DEBUG_SPRINTF("useRandomAccessPointFlag = %d", (int)self->useRandomAccessPointFlag);
        DEBUG_SPRINTF("useRandomAccessUnitsOnlyFlag = %d", (int)self->useRandomAccessUnitsOnlyFlag);
        DEBUG_SPRINTF("usePaddingFlag = %d", (int)self->usePaddingFlag);
        DEBUG_SPRINTF("useTimestampsFlag = %d", (int)self->useTimestampsFlag);
        DEBUG_SPRINTF("useIdleFlag = %d", (int)self->useIdleFlag);
        DEBUG_SPRINTF("durationFlag = %d", (int)self->durationFlag);
        ...
        DEBUG_SPRINTF("degradationPriorityLength = %d", (int)self->degradationPriorityLength);
        DEBUG_SPRINTF("AUSeqNumLength = %d", (int)self->AUSeqNumLength);
        DEBUG_SPRINTF("packetSeqNumLength = %d", (int)self->packetSeqNumLength);
    }
