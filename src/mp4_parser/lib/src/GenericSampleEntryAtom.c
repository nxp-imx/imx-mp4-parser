...
*/
/*
    $Id: GenericSampleEntryAtom.c,v 1.2 2000/05/17 08:01:28 francesc Exp $
*/
...
static MP4Err createFromInputStream(MP4AtomPtr s, MP4AtomPtr proto, MP4InputStreamPtr inputStream) {
    ...
    // fix ENGR00172073, some sample description may not have additional data, so dataSize may be 0.
    if (self->dataSize) {
...
MP4Err MP4CreateGenericSampleEntryAtom(MP4GenericSampleEntryAtomPtr* outAtom) {
    ...
    self = (MP4GenericSampleEntryAtomPtr)MP4LocalCalloc(1, sizeof(MP4GenericSampleEntryAtom));
    TESTMALLOC(self);
