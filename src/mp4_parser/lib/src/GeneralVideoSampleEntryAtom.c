...
static void destroy(MP4AtomPtr s) {
    MP4Err err;
    GeneralVideoSampleEntryAtomPtr self;
    err = MP4NoErr;
    self = (GeneralVideoSampleEntryAtomPtr)s;
    if (self == NULL)
...
static MP4Err createFromInputStream(MP4AtomPtr s, MP4AtomPtr proto, MP4InputStreamPtr inputStream) {
    MP4Err err;
    GeneralVideoSampleEntryAtomPtr self = (GeneralVideoSampleEntryAtomPtr)s;
...
MP4Err MP4CreateGeneralVideoSampleEntryAtom(GeneralVideoSampleEntryAtomPtr* outAtom, u32 type) {
    ...
    self = (GeneralVideoSampleEntryAtomPtr)MP4LocalCalloc(1, sizeof(GeneralVideoSampleEntryAtom));
    TESTMALLOC(self)
