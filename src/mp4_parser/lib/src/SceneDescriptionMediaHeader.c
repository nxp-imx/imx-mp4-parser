...
*/
/*
    $Id: SceneDescriptionMediaHeader.c,v 1.2 2000/05/17 08:01:31 francesc Exp $
*/
...
MP4Err MP4CreateSceneDescriptionMediaHeaderAtom(MP4SceneDescriptionMediaHeaderAtomPtr* outAtom) {
    ...
    self = (MP4SceneDescriptionMediaHeaderAtomPtr)MP4LocalCalloc(
            1, sizeof(MP4SceneDescriptionMediaHeaderAtom));
    TESTMALLOC(self)
