...
static MP4Err createFromInputStream(MP4AtomPtr s, MP4AtomPtr proto, MP4InputStreamPtr inputStream) {
    MP4Err err = MP4NoErr;
    u32 bytesToRead;
    MP4H263AtomPtr self = (MP4H263AtomPtr)s;
...
MP4Err MP4CreateD263Atom(MP4H263AtomPtr* outAtom) {
    MP4Err err;
    MP4H263AtomPtr self;

    self = (MP4H263AtomPtr)MP4LocalCalloc(1, sizeof(MP4H263Atom));
    TESTMALLOC(self)
