...
*/
/*
    $Id: DegradationPriorityAtom.c,v 1.2 2000/05/17 08:01:27 francesc Exp $
*/
...
static MP4Err createFromInputStream(MP4AtomPtr s, MP4AtomPtr proto, MP4InputStreamPtr inputStream) {
    ...
    self->priorities = (u32*)MP4LocalCalloc(self->entryCount, sizeof(u32));
...
MP4Err MP4CreateDegradationPriorityAtom(MP4DegradationPriorityAtomPtr* outAtom) {
    ...
    self = (MP4DegradationPriorityAtomPtr)MP4LocalCalloc(1, sizeof(MP4DegradationPriorityAtom));
    TESTMALLOC(self);
    ...
    self->name = "degradation prioritye";
