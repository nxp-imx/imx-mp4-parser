...
#ifndef TEST_RETURN
#define TEST_RETURN(err) (void)(err)
...
// typedef unsigned long u32; //keep consistent with uint32
...
void* MP4LocalCalloc(u32 TotalNumber, u32 TotalSize);

/* Local Fucntion for malloc. */
void* MP4LocalMalloc(u32 TotalSize);

/* Local Fucntion for Re Alloc. */
void* MP4LocalReAlloc(void* MemoryBlock, u32 TotalSize);
